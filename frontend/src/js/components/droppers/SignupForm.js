...
class SignUp extends React.Component {
  ...
  handleSubmit = event => {
    ...
    // console.log('@handleSubmit', , typeof createUser, this.state);
...
// export const SignupTest = withStyles(styles)(SignUp);

// export default withAuthUser(SignupTest);
export default withAuthUser(withStyles(styles)(SignUp));
